...
class SolrDocumentValueSpec extends Specification with JUnit {
  ...
  "toCalendarOrElse" should {
    "be available" in {
      ...
      val expected = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parseDateTime("2010-12-31T23:59:59.000Z")
  ...
  "toDateTimeOrElse" should {
    "be available" in {
      ...
      val expected = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parseDateTime("2010-12-31T23:59:59.10Z")
  ...
  "toLocalTimeOrElse" should {
    "be available" in {
      val value = new SolrDocumentValue("2010-12-31T23:59:59.000Z")
      val dateTime = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").parseDateTime("2010-12-31T23:59:59.000Z")
