...
class SolrClient_doQueryJavabinResponseTest extends Assertions {

  val log = new Log(LoggerFactory.getLogger(classOf[SolrClient_doQueryJavabinResponseTest]))
  ...
  @Ignore
  @Test
  def availableInJavabinWithGroupParams() {
    val request = new QueryRequest(
      writerType = WriterType.JavaBinary,
      query = Query("genre_s:fantasy"),
      group = GroupParams(enabled = true, field = GroupField("author_t")))
  ...
  @Ignore
  @Test
  def availableInJavabinWithGroupParamsWithSimpleFormat() {
    val request = new QueryRequest(
      writerType = WriterType.JavaBinary,
      query = Query("genre_s:fantasy"),
      group = GroupParams(enabled = true, field = GroupField("author_t"), format = GroupFormat("simple")))
  ...
  @Ignore
  @Test
  def availableInJavabinWithGroupParamsWithSimpleFormatAndMain() {
    val request = new QueryRequest(
      writerType = WriterType.JSON,
      query = Query("genre_s:fantasy"),
      group = GroupParams(
  ...
  @Test
  def availableInJavabinWithHighlightingParams() {
    val request = new QueryRequest(
      writerType = WriterType.JavaBinary,
      query = Query("author:Rick"),
      sort = Sort("page_i desc"),
